...
SuperMarioBros.EditScene = JavaScript.Class(ALittle.DisplayLayout, {
	TCtor : function() {
		...
		this.AddEntity("wall_1", 2, this._entity_wall_1);
		this.AddEntity("hide_wall_1", 4, this._entity_hide_wall_1);
		this.AddEntity("random_wall_1", 1, this._entity_random_wall_1);
		this.AddEntity("enemy_1", 3, this._entity_enemy_1);
		this.AddEntity("enemy_2", 5, this._entity_enemy_2);
		this.AddEntity("flag_1", 6, this._entity_flag_1);
		this.AddEntity("flag_2", 7, this._entity_flag_2);
		this.AddEntity("flag_3", 8, this._entity_flag_3);
		this.AddEntity("flag_4", 9, this._entity_flag_4);
		this.AddEntity("flag_5", 10, this._entity_flag_5);
		this.AddEntity("born_1", 11, this._entity_born_1);
		this._select_frame._user_data = this._entity_info_map.get(1);
	},
